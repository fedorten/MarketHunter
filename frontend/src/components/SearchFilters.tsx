  ...
  return (
    <section className="search-band">
      ...
      <div className="filters-row">
        ...
        <input value={filters.location} onChange={(event) => set('location', event.target.value)} placeholder="Город" />
        <input value={filters.priceMin} onChange={(event) => set('priceMin', event.target.value)} inputMode="numeric" placeholder="Цена от" />
        <input value={filters.priceMax} onChange={(event) => set('priceMax', event.target.value)} inputMode="numeric" placeholder="до" />
